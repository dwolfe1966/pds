...
/**
 * Phone search landing v4 – Find a Lost Contact.
 * 3-step flow: Phone → Location → Confirm → Results.
 */
const PhoneSearchLandingV4Page = () => {
  const brand = useBrand();
  useLandingTrack('phone', 'v4');
    ...
    <main className={styles.main}>
      <div className={styles.wrapper}>
        ...
        <div className={styles.card}>
          <h1 className={styles.title}>Find a Lost Contact</h1>
          <p className={styles.subtitle}>
            Have their old number? We&apos;ll help you find their current address and contact info.
          </p>
          ...
          {step === 'phone' && (
            <form className={styles.form} onSubmit={startSearch}>
              ...
              <div className={styles.fieldGroup}>
                <label className={styles.label} htmlFor="v4-phone">Phone Number</label>
                <input
                  id="v4-phone"
                  type="tel"
          ...
          {step === 'location' && (
            <div className={styles.form}>
              ...
              <p className={styles.helperText}>Helps narrow your search. Optional.</p>
...
export default PhoneSearchLandingV4Page;
