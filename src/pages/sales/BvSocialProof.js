...
const ss = {
  ...
  statNum: { display: 'block', fontSize: 18, fontWeight: 700, color: '#0369a1' },
  statLbl: { fontSize: 11, color: '#6b7280' },
  liveStat: { textAlign: 'center', margin: '.75rem 0' },
  liveNum: { display: 'block', fontSize: 18, fontWeight: 700, color: '#0369a1', fontVariantNumeric: 'tabular-nums' },
