...
/**
 * Phone search landing v5 – Business Number Lookup.
...
const PhoneSearchLandingV5Page = () => {
  ...
  useEffect(() => {
    ...
    if (step === 'searching-one') {
      timer = setTimeout(() => { track('search_step', { step: 'location', search_type: 'phone', variant: 'v5' }); setStep('location'); }, 1700);
    }
    return () => {
  ...
  useEffect(() => {
    ...
    const runSearch = async () => {
      try {
        setFinalStatus('Checking business registrations...');
        setFinalProgress(10);
  ...
  const startSearch = (e) => {
    ...
    track('search_step', { step: 'searching-one', search_type: 'phone', variant: 'v5' });
    setStep('searching-one');
  };

  const continueFromLocation = () => { track('search_step', { step: 'confirm', search_type: 'phone', variant: 'v5' }); setStep('confirm'); };
  ...
  const handleConfirm = () => {
    ...
    track('search_step', { step: 'final-search', search_type: 'phone', variant: 'v5' });
    track('fcra_agree', { search_type: 'phone', variant: 'v5' });
    ...
    <main className={styles.main}>
      <div className={styles.wrapper}>
        <p className={styles.pageSubtitle}>
          <span className={styles.pageSubtitleIcon} aria-hidden>🏢</span> Business Phone Lookup
        </p>
        ...
        <div className={styles.card}>
          <h1 className={styles.title}>Is This a Legitimate Business?</h1>
          <p className={styles.subtitle}>
            Look up any business or unknown number to verify ownership and legitimacy.
          </p>
          ...
          {step === 'phone' && (
            <form className={styles.form} onSubmit={startSearch}>
              <h2 className={styles.sectionTitle}>Enter the Business Phone Number</h2>
              <p className={styles.helperText}>We&apos;ll search business registration and owner records.</p>

              <div className={styles.fieldGroup}>
                <label className={styles.label} htmlFor="v5-phone">Phone Number</label>
                <input
                  id="v5-phone"
                  type="tel"
          ...
          {step === 'searching-one' && (
            <div className={styles.searching}>
              ...
              <p className={styles.helperText}>Checking business registrations...</p>
          ...
          {step === 'location' && (
            <div className={styles.form}>
              <h2 className={styles.sectionTitle}>Which State Is This Business In?</h2>
              <p className={styles.helperText}>Helps find the right registration records. Optional.</p>
...
export default PhoneSearchLandingV5Page;
