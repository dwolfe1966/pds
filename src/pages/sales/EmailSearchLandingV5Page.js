...
/**
 * Email search landing v5 – Business Email Lookup.
 * 3-step flow: Email → Context/Location → Confirm → Results.
 */
const EmailSearchLandingV5Page = () => {
  useLandingTrack('email', 'v5');
  ...
  useEffect(() => {
    ...
    const runSearch = async () => {
      try {
        setFinalStatus('Checking business records...');
        setFinalProgress(10);
    ...
    <main className={styles.main}>
      <div className={styles.wrapper}>
        <p className={styles.pageSubtitle}>
          <span className={styles.pageSubtitleIcon} aria-hidden>🏢</span> Business Email Lookup
        </p>
        ...
        <div className={styles.card}>
          <h1 className={styles.title}>Verify a Business Contact</h1>
          <p className={styles.subtitle}>
            Look up any business email to verify ownership and check their professional background.
          </p>
          ...
          {step === 'email' && (
            <form className={styles.form} onSubmit={startSearch}>
              <h2 className={styles.sectionTitle}>Enter the Business Email</h2>
              <p className={styles.helperText}>We&apos;ll verify ownership and check business registration records.</p>

              <div className={styles.fieldGroup}>
                <label className={styles.label} htmlFor="v5-email">Email Address</label>
                <input
                  id="v5-email"
                  type="email"
          ...
          {step === 'searching-one' && (
            <div className={styles.searching}>
              ...
              <p className={styles.helperText}>Checking business records...</p>
          ...
          {step === 'context' && (
            <div className={styles.form}>
              ...
              <p className={styles.helperText}>Optional — helps find registration records.</p>
...
export default EmailSearchLandingV5Page;
