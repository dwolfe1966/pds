...
const NameSearchLandingV3aPage = () => {
  ...
  useEffect(() => {
    let t;
    if (step === 'searching-one') t = setTimeout(() => { track('search_step', { step: 'location', search_type: 'name', variant: 'v3a' }); setStep('location'); }, 5000);
    if (step === 'searching-two') t = setTimeout(() => { track('search_step', { step: 'details', search_type: 'name', variant: 'v3a' }); setStep('details'); }, 5000);
        ...
        <div style={card}>
          ...
          {step === 'details' && (
            <div>
              ...
              <p style={{ margin: '0 0 1rem', fontSize: '0.9rem', color: P.mut }}>A few more details help us surface the exact person.</p>
          ...
          {step === 'confirm' && (
            <div>
              ...
              <p style={{ margin: '0 0 1rem', fontSize: '0.88rem', color: P.mut }}>Because this information can be misused, we ask every searcher to confirm they&apos;ll use it responsibly.</p>
