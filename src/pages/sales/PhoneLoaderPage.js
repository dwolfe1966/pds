  ...
  useEffect(() => {
    const performSearch = async () => {
      ...
      try {
        ...
        track('search_submit', { type: 'phone', resultCount: identityCount });
        gtmSearchSubmit({ search_type: 'phone', result_count: identityCount });
        // Persist visitor search intent for replay on signup.
        appendSearch({ type: 'phone', query: { phone }, resultCount: identityCount });
