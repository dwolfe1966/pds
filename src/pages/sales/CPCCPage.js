  ...
  return (
    <main className="pageBackground">
      ...
      <section style={{ marginBottom: '2rem' }}>
        <h2 style={{ color: '#0d5d2f', marginBottom: '1rem' }}>Your California Privacy Rights</h2>
        <p style={{ color: '#111827', lineHeight: '1.8', marginBottom: '1rem' }}>
      ...
      <section style={{ marginBottom: '2rem' }}>
        <h2 style={{ color: '#0d5d2f', marginBottom: '1rem' }}>How to Exercise Your Rights</h2>
        <div style={{ padding: '1.5rem', backgroundColor: '#f9fafb', borderRadius: '0.375rem', marginBottom: '1rem' }}>
          <h3 style={{ color: '#0d5d2f', marginTop: 0 }}>Request to Know</h3>
        ...
        <div style={{ padding: '1.5rem', backgroundColor: '#f9fafb', borderRadius: '0.375rem', marginBottom: '1rem' }}>
          <h3 style={{ color: '#0d5d2f', marginTop: 0 }}>Request to Delete</h3>
          <p style={{ color: '#6b7280', lineHeight: '1.6' }}>
        ...
        <div style={{ padding: '1.5rem', backgroundColor: '#f9fafb', borderRadius: '0.375rem' }}>
          <h3 style={{ color: '#0d5d2f', marginTop: 0 }}>Request to Opt-Out</h3>
          <p style={{ color: '#6b7280', lineHeight: '1.6' }}>
      ...
      <section style={{ marginBottom: '2rem' }}>
        <h2 style={{ color: '#0d5d2f', marginBottom: '1rem' }}>Verification Process</h2>
      ...
      <section style={{ marginBottom: '2rem' }}>
        <h2 style={{ color: '#0d5d2f', marginBottom: '1rem' }}>Authorized Agents</h2>
        <p style={{ color: '#6b7280', lineHeight: '1.8' }}>
