...
export const SELF_CHROME_PREFIXES = ['/name/landing/v7', '/name/landing/v8', '/name/landing/v9', '/name/landing/v10', '/name/landing/v3', '/name/landing/v3a', '/name/landing/v3b', '/name/search-result', '/search-results'];
