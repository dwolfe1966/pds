  ...
  const submit = useCallback(async ({
    ...
    try {
      ...
      if (response.accessToken) {
        ...
        // NO account-created/welcome email here (owner VIP 2026-07-27): signup is free/pre-payment, so we do
        // NOT email until they pay. Transactional account emails post-payment are BC's job; our platform sends
        // MARKETING only (abandoned-cart recovery + the lead drip).
      }
