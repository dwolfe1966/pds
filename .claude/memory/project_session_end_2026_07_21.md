...
**CURRENT CONSUMER BUNDLE (social ON + onboarding, for testing): `public.90c8387b.js`** (default/production build without REACT_APP_SIGNALS_SOCIAL keeps social OFF). NOT on BC.
