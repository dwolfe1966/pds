...
**CURRENT CONSUMER BUNDLE (social ON + onboarding, for testing): `public.aaa166f4.js`** (default/production build without REACT_APP_SIGNALS_SOCIAL keeps social OFF). NOT on BC.
