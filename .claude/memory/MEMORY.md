...
- [WSFY self-build](project_wsfy_self_build.md) — build Who's-Searching-For-You ourselves (BC has none); Phase 1 search-activity ingest SHIPPED (bundle public.b62e03de.js, not yet on BC); Phase 2 reveal parked on privacy posture
