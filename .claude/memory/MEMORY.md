...
- 2026-06-19 CSR work: runnable demo `scripts/demo-bc-csr-asks.js` (3 BC asks A/B/C + confirm; default dev account; VERBOSE=1) + `docs/BC_CSR_ASKS_PACKAGE.md` + `docs/CSR_FEATURE_STATUS.md`; new agents bc-asks-register + product-quality-reviewer; `_viaCsr` double-mutation fix + product-quality A/B/C fixes shipped (bundle admin.37df5409.js)
