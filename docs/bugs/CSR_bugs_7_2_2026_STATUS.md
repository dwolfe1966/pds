...
5. ~~zip→state fallback display~~ ✅ DONE (full "City, ST"): GeoNames-derived 41k-ZIP map
   (CC BY 4.0), generated by `scripts/generate-zip-geo.js`, lazy-loaded as its own admin
   chunk; profile "Zip" row is now "Location: Anaheim, CA 92807". Still interim until ASK H.
