  ...
  return (
    <div style={{ display: 'flex', gap: 12, border: `1px solid ${ui.color.softBorder}`, borderRadius: 8, padding: '12px 14px', background: '#fff' }}>
      ...
      <div style={{ minWidth: 0, flex: 1 }}>
        <div style={{ fontWeight: 800, color: ui.color.ink }}>
        ...
        {aka && <div style={{ fontSize: 12.5, color: ui.color.muted, marginTop: 2 }}>AKA {cap(aka)}</div>}
        {rec.registryUrl && (
          <div style={{ marginTop: 4 }}>
            <a href={rec.registryUrl} target="_blank" rel="noopener nofollow" style={{ ...ui.link, fontSize: 12.5 }}>
...
export function SexOffenderSection({ records, heading, blurb }) {
  ...
  return (
    <section style={{ ...ui.card, marginTop: 20 }}>
      ...
      <p style={{ ...ui.source, marginTop: 12, lineHeight: 1.5 }}>
